...
\lstinputlisting[language=Matlab]{/home/jay/Desktop/Dsp-lab/Experiment-7/codes/main.m}
\section{LPF}
...
\begin{figure}[ht] % 'h' specifies here (at the current location)
  ...
  \begin{minipage}[t]{0.45\textwidth}
    \includegraphics[width=\linewidth]{/home/jay/Desktop/Dsp-lab/Experiment-7/codes/spect_lpf.jpg}
    \caption{Low pass filtered spectogram}
  \end{minipage}\hfill
  \begin{minipage}[t]{0.45\textwidth}
    \includegraphics[width=\linewidth]{/home/jay/Desktop/Dsp-lab/Experiment-7/codes/spect_org.jpg}
    \caption{Orginal spectogram}
  \end{minipage}
\end{figure}\begin{figure}[ht] % 'h' specifies here (at the current location)
  \centering
  \includegraphics[width=0.6\textwidth]{/home/jay/Desktop/Dsp-lab/Experiment-7/codes/mag_lpf.jpg}
...
\begin{figure}[ht] % 'h' specifies here (at the current location)
  \centering
  \begin{minipage}[t]{0.45\textwidth}
    \includegraphics[width=\linewidth]{/home/jay/Desktop/Dsp-lab/Experiment-7/codes/spect_hpf.jpg}
...
\end{figure}\begin{figure}[ht] % 'h' specifies here (at the current location)
  \centering
  \includegraphics[width=0.6\textwidth]{/home/jay/Desktop/Dsp-lab/Experiment-7/codes/mag_hpf.jpg}
  \caption{Magnitude/Phase response for LPF}
\end{figure}
\clearpage
...
\begin{figure}[ht] % 'h' specifies here (at the current location)
  \centering
  \includegraphics[width=0.6\textwidth]{/home/jay/Desktop/Dsp-lab/Experiment-7/codes/imp_res.jpg}
