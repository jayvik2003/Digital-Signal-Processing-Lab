...
\lstinputlisting[language=Matlab]{/home/jay/Desktop/Dsp-lab/Experiment-4/codes/main.m}
The following got computed in  Matlab,\\
\begin{figure}[h] % 'h' specifies here (at the current location)
  \centering
  \includegraphics[width=1\textwidth]{/home/jay/Desktop/Dsp-lab/Experiment-4/codes/mat.png}
...
\begin{figure}[h] % 'h' specifies here (at the current location)
  \centering
  \includegraphics[width=0.6\textwidth]{/home/jay/Desktop/Dsp-lab/Experiment-4/codes/convl_plot.png}
  \caption{Squared Error Plot of fix point convolution(square error VS index of each element of o/p)}
  \label{fig:your_label}
\end{figure}
\begin{figure}[h] % 'h' specifies here (at the current location)
  \centering
  \includegraphics[width=0.6\textwidth]{/home/jay/Desktop/Dsp-lab/Experiment-4/codes/corr_plot.png}
  \caption{Squared Error Plot of fix point correlation(square error VS index of each element of o/p)}
  \label{fig:your_label}
\end{figure}
\clearpage
\textbf{C simulation,}
\lstinputlisting[language=C]{/home/jay/Desktop/Dsp-lab/Experiment-4/codes/main.c}
The following got computed in  C,\\
\begin{figure}[h] % 'h' specifies here (at the current location)
  \centering
  \includegraphics[width=\textwidth]{/home/jay/Desktop/Dsp-lab/Experiment-4/codes/C.png}
  \label{fig:your_label}
\end{figure}
